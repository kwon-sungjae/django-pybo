    ...
    $.ajax({
        ...
        success: function(response) {
            response.messages.forEach(function(message) {
                ...
                var timestampHtml = $('<div class="message-timestamp"></div>');
                messageHtml.html('<strong>' + message.user + ':</strong> ' + message.content);
                timestampHtml.html('<strong>' + message.timestamp);
                $('#chat-log').append(messageHtml);
                $('#chat-log').append(timestampHtml);
            });
